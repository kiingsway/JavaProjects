...
import static org.example.model.TranslateItemModel.getTranslationDifficulties;
...
public class DatabaseFormController {
    ...
    public DatabaseFormController(DatabaseFormView view, Runnable updateTranslateList) throws SQLException {
        ...
        view.addWindowListener((SimpleWindowListener) _ -> closeDatabaseForm());
    }
    ...
    private void closeDatabaseForm() {Constants.GO_DATABASE(view, updateTranslateList);}
}
